...
<head>
  ...
  <title>PM ADMIN - Dashboard</title>
  <!-- Icon Website  -->
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> Type1
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-success"></i> Type2
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-info"></i> Type3
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-danger "></i> Type4
                    </span>
                  </div>
                </div>
              </div>
